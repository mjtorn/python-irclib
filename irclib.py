...
class IRC:
    ...
    def _handle_event(self, connection, event):
        """[Internal]"""
        h = self.handlers
        for handler in h.get(b"all_events", []) + h.get(event.eventtype(), []):
...
class Event:
    ...
    def __init__(self, eventtype, source, target, arguments=None):
        ...
        # The regexp requires bytes
        if isinstance(eventtype, str):
            eventtype = eventtype.encode('utf-8')

        # Not gonna analyze, assume at least some sources are bytes, make all of them
...
numeric_events = {
    ...
    b"432": b"erroneusnickname", # Thiss iz how its speld in thee RFC.
    b"433": b"nicknameinuse",
    b"436": b"nickcollision",
    b"437": b"unavailresource",  # b"Nick temporally unavailable"
    ...
    b"465": b"yourebannedcreep", # I love this one...
    ...
    b"476": b"badchanmask",
    b"477": b"nochanmodes",  # b"Channel doesn't support modes"
    b"478": b"banlistfull",
    b"481": b"noprivileges",
    b"482": b"chanoprivsneeded",
    b"483": b"cantkillserver",
    b"484": b"restricted",   # Connection is restricted
